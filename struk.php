...
if (isset($_GET['pesanan_id'])) {
    ...
    $query = "SELECT p.pesanan_id, p.total_price, p.status_pesanan, p.order_date,
                     p.pelanggan_name, p.pelanggan_address, p.pelanggan_kota,
                     p.pelanggan_provinsi, p.pelanggan_kodepos, p.pelanggan_negara, p.pelanggan_nohp
              FROM pesanan p
...
<div class="container">
    <div class="receipt p-4 border rounded" id="struk">
        ...
        <p><strong>Alamat:</strong><br>
            ...
            <?php echo htmlspecialchars($order_data['pelanggan_provinsi']); ?>,
            <?php echo htmlspecialchars($order_data['pelanggan_kodepos']); ?>,
            <?php echo htmlspecialchars($order_data['pelanggan_negara']); ?><br>
            No. HP: <?php echo htmlspecialchars($order_data['pelanggan_nohp']); ?>
        </p>
        ...
        <div class="details">
            ...
            <ul>
                <?php
                $query_detail = "SELECT dp.quantity, dp.price, pr.product_name
        ...
        <a href="daftar_pesanan.php" class="btn-download">Kembali ke Daftar Pesanan</a>
    </div>
</div>
